...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ('product_name', 'brand', 'price', 'main_category', 'sub_category', 'modified_date', 'is_available')
    inlines = [ProductGalleryInline]


class VariationAdmin(admin.ModelAdmin):
    list_display = ('product', 'variation_size', 'is_active')
    list_editable = ('is_active',)
    list_filter = ('product', 'variation_size')
